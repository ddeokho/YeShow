...
public class tableup2VO implements Serializable{
	...
	//JOIN
	private Integer restime;//예약한 시간
	private String resdate;//예약한 날짜
	private String restable;//예약한 테이블번호
...
//////////////////////////////////////////////////////////////////
	...
	public tableup2VO(Integer tablenum, Integer tableuser, String opentime1, String closetime1, String opentime2,
	...
	public tableup2VO(Integer tablenum, Integer tableuser, String opentime1, String closetime1, String opentime2,
			String closetime2, Integer upnum, Integer idx, Integer restime, String resdate) {
		super();
		this.tablenum = tablenum;
		this.tableuser = tableuser;
		this.opentime1 = opentime1;
