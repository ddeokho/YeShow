...
public class Paging2VO implements Serializable{
	...
	public Paging2VO(int cpage, int pageSize, int totalCount, int pagingBlock) {
		super();
		this.cpage = cpage;
...
nextBlock=prevBlock+(pagingBlock+1)
	...
	public String getPageNavi(String myctx, String loc){
		...
		String str="";
		//검색시 필요한 쿼리 스트링
		String queryStr="?findType="+findType+"&findString="+findString+"&pageSize="+pageSize;
		
		StringBuilder buf=new StringBuilder().append("<ul class='pagination pagination-sm'>");
				if(prevBlock>0){
	...
	public String toString() {
		return "PagingVO [cpage=" + cpage + ", pageSize=" + pageSize + ", totalCount=" + totalCount + ", pageCount="
				...
				+ prevBlock + ", nextBlock=" + nextBlock + ", findType=" + findType + ", findString=" + findString
				+ "]";
	}
