...
<form role="form" name="mf" id="mf" action="${pageContext.request.contextPath}/memberEditEnd.do" method="POST">
	<div class="container">
	...
	<div class="form-group hidden-lg hidden-md hidden-sm" id="divmohp">
		<label class="control-label" for="mhp3">핸드폰</label>
			<input type="text" class="form-control" name="mhp3" id="mhp3"
				value="${user.hp1}-${user.hp2}-${user.hp3}" maxlength="11">
	...
	<div class="form-group" id="laddr2">
		<input class="form-control" type="text" name="addr2" id="sample6_address2"
			style="margin: 5px 0px 0px 0px" value="${user.addr2}">
		<span style="display: none;" id="addr2Help" class="help-block">상세주소를 입력하세요.</span>
	</div>
	<div class="text-right">
		<button id="btpost" type="button" class="btn btn-primary" onclick="check()">회원수정</button>
		<button id="btDel" type="button" class="btn btn-denger" onclick="del('${user.idx}')">회원탈퇴</button>
	</div>
	</div>
</form>
