	var lastDay=function(year, month){
		...
		case 2:{
			/*윤년
			1) 기원 년수가 4로 나누어 떨어지는 해를 우선 윤년(29이)
	...
	var showCal=function(year, month){
		...
		for(var i=1;i<=total_days;i++){
			...
			switch(col&7){
			case 0://일요일
			str+="<td width='30' height='25' class='sun'>"+i+"</td>";//토
			break;
			case 6:
			str+="<td width='30' height='25' class='sat'>"+i+"</td>";//일
			break;
			default://평일
			str+="<td width='30' height='25' class='work'>"+i+"</td>";
			}//switch--
			col++;
			if(col==7){
				str+="</tr>";//줄바꿈
